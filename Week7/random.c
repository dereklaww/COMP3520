...
NSW 2006
Australia
Copyright of this code and associated material is vested in the University of
Sydney.
...
int main (int argc, char *argv[])
{
    ...
    /* Try to open a new file for writing. If the file already exists, it will be
    overwritten. */
    ...
    {
        /* Generate intervals between job arrivals in accordance with the Poisson
        distribution */
