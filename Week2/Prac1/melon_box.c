...
int main(int argc, char ** argv)
{
    ...
    rc = pthread_mutex_init(&melon_box_mutex, NULL);
    ...
    rc = pthread_create(&threads[0], NULL, farmer_routine, (void *)
    &farmer_pace); //farmer routine takes farmer_pace as the arg
...
//  gcc -Wall -pedantic -std=gnu99 melon_box.c -o melon_box -lpthread
